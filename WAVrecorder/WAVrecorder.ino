...
static const uint8_t  recording_channel_number = 2;
...
static const int32_t recoding_byte_per_second = AS_SAMPLINGRATE_48000 *
                                                AS_BITLENGTH_24 *
...
void setup()
{
  ...
  theAudio->setRecorderMode(AS_SETRECDR_STS_INPUTDEVICE_MIC, 20);
...
void loop() 
{
  ...
  // if (theAudio->getRecordingSize() > 100000000) or recording_size
  if (millis() - previous > 10*MINUTE)
    {
